#' Show the trend index time series as a Shiny module
#'
#' [indexTrendModuleUI()] returns a [shiny::tagList()] and [indexTrendModuleServer()]
#' returns nothing.
#'
#'
#' @param id The identifier string linking the module functions.
#' @param choices The name of the trend indices of interest.
#' @param trend_data A data frame with the following columns.
#'  * `type` (`character`)
#'  * `date` (`Date`)
#'  * `close` (`numeric`)
